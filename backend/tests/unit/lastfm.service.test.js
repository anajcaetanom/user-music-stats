...
describe('LastFM Service', () => {
    ...
    describe('fetchUserTopArtists', () => {
        it('should throw error if username is missing', async () => {
            await expect(lastfmService.fetchUserTopArtists()).rejects.toThrow(
                'Username is missing.',
            );
        });

        it('should throw error if period is missing', async () => {
            await expect(lastfmService.fetchUserTopArtists('ana')).rejects.toThrow(
                'Period is missing.',
            );
        });
        ...
        it('should call client with corret params', async () => {
            ...
            const result = await lastfmService.fetchUserTopArtists('ana', 2, '7day');
            expect(lastfmClient.getUserTopArtists).toHaveBeenCalledWith('ana', 2, '7day');
            expect(result).toEqual(['Ariana Grande', 'Sabrina Carpenter']);
        });
        ...
        it('should use default limit 10 if not provided', async () => {
            ...
            await lastfmService.fetchUserTopArtists('ana', undefined, '7day');
            expect(lastfmClient.getUserTopArtists).toHaveBeenCalledWith('ana', 10, '7day');
        });
    });
    ...
    describe('fetchUserTopAlbums', () => {
        it('should throw error if username is missing', async () => {
            await expect(lastfmService.fetchUserTopAlbums()).rejects.toThrow(
                'Username is missing.',
            );
        });

        it('should throw error if period is missing', async () => {
            await expect(lastfmService.fetchUserTopAlbums('ana')).rejects.toThrow(
                'Period is missing.',
            );
        });
    ...
    describe('fetchUserTopTracks', () => {
        it('should throw error if username is missing', async () => {
            await expect(lastfmService.fetchUserTopTracks()).rejects.toThrow(
                'Username is missing.',
            );
        });

        it('should throw error if period is missing', async () => {
            await expect(lastfmService.fetchUserTopTracks('ana')).rejects.toThrow(
                'Period is missing.',
            );
        });
    ...
    describe('fetchUserProfilePic', () => {
        it('should throw error if username is missing', async () => {
            await expect(lastfmService.fetchUserProfilePic()).rejects.toThrow(
                'Username is missing.',
            );
        });
        ...
        it('should throw error if client returns null', async () => {
            ...
            await expect(lastfmService.fetchUserProfilePic('ana')).rejects.toThrow(
